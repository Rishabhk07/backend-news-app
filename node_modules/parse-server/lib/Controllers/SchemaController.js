...
var systemClasses = Object.freeze(['_User', '_Installation', '_Role', '_Session', '_Product', '_PushStatus', '_JobStatus', '_JobSchedule', '_Audience']);

var volatileClasses = Object.freeze(['_JobStatus', '_PushStatus', '_Hooks', '_GlobalConfig', '_JobSchedule', '_Audience']);
...
var CLPValidKeys = Object.freeze(['find', 'count', 'get', 'create', 'update', 'delete', 'addField', 'readUserFields', 'writeUserFields']);
...
var validNonRelationOrPointerTypes = ['Number', 'String', 'Boolean', 'Date', 'Object', 'Array', 'GeoPoint', 'File', 'Bytes'];
...
var _JobScheduleSchema = convertSchemaToAdapterSchema(injectDefaultSchema({
  className: "_JobSchedule",
  fields: {},
  classLevelPermissions: {}
}));
var _AudienceSchema = convertSchemaToAdapterSchema(injectDefaultSchema({
  className: "_Audience",
  fields: defaultColumns._Audience
}));
var VolatileClassesSchemas = [_HooksSchema, _JobStatusSchema, _JobScheduleSchema, _PushStatusSchema, _GlobalConfigSchema, _AudienceSchema];
...
var SchemaController = function () {
  ...
  _createClass(SchemaController, [{
    ...
    value: function updateClass(className, submittedFields, classLevelPermissions, database) {
      ...
      return this.getOneSchema(className).then(function (schema) {
        ...
        if (deletedFields.length > 0) {
          deletePromise = _this5.deleteFields(deletedFields, className, database);
        }
    ...
    key: 'deleteFields',
    value: function deleteFields(fieldNames, className, database) {
      var _this9 = this;
      ...
      return this.getOneSchema(className, false, { clearCache: true }).catch(function (error) {
        ...
        var schemaFields = _extends({}, schema.fields);
        return database.adapter.deleteFields(className, schema, fieldNames).then(function () {
    ...
    value: function validatePermission(className, aclGroup, operation) {
      ...
      var permissionField = ['get', 'find', 'count'].indexOf(operation) > -1 ? 'readUserFields' : 'writeUserFields';
