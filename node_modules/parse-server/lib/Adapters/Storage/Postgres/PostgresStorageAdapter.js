...
var PostgresStorageAdapter = exports.PostgresStorageAdapter = function () {
  ...
  _createClass(PostgresStorageAdapter, [{
    ...
    value: function performInitialization(_ref4) {
      ...
      promises = promises.concat([this._client.none(_sql2.default.misc.jsonObjectSetKeys).catch(function (err) {
        console.error(err);
      }), this._client.none(_sql2.default.array.add).catch(function (err) {
        console.error(err);
      }), this._client.none(_sql2.default.array.addUnique).catch(function (err) {
        console.error(err);
      }), this._client.none(_sql2.default.array.remove).catch(function (err) {
        console.error(err);
      }), this._client.none(_sql2.default.array.containsAll).catch(function (err) {
        console.error(err);
      }), this._client.none(_sql2.default.array.contains).catch(function (err) {
        console.error(err);
      })]);
